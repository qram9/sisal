...
extern "C" struct FUNC_MAIN_results func_MAIN(int32_t N) {
  ...
  sisal_array_t v_g1_n__1_p1_o = {0};
  {
    ...
    int32_t v_FORALL_10001_n__3___forall_body_1;
    ...
    (v_g1_n__1_p1_o = sisal_array_alloc_empty(1, 6, ((uint64_t)(1 * ((v_GENERATOR_10003_n__0_N - 1) + 1)))));
    ...
    for ((v_GENERATOR_10003_n__2_I = 1); (v_GENERATOR_10003_n__2_I <= v_GENERATOR_10003_n__0_N); (v_GENERATOR_10003_n__2_I++)) {
      ...
      (v_BODY_10004_n__3_p0_o = SISAL_CAST(int32_t, (SISAL_CAST(int32_t, v_BODY_10004_n__0_I) * SISAL_CAST(int32_t, v_BODY_10004_n__0_I))));
      (((double *)v_g1_n__1_p0_o.data)[__g_10001] = SISAL_CAST(double, v_BODY_10004_n__1_p0_o));
      (((int32_t *)v_g1_n__1_p1_o.data)[__g_10001] = SISAL_CAST(int32_t, v_BODY_10004_n__3_p0_o));
      (__g_10001++);
    }
  }
