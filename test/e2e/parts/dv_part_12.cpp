...
// Groups: FORALL_DV_CROSS, FORALL_DV_DOT, FORALL_DV_DOT3, RED_SUM, RED_PRODUCT, RED_GREATEST, RED_LEAST, RED_ARGMAX, RED_ARGMIN, RED_SUM_CROSS, FOR_INITIAL, GAUSSJ_PARTS, GAUSSJ, SWAPLOOP, GEN_EXTENT, BROADCAST_PARTS, IF_COND, FORALL_DV_SIMPLE, CROSS_DV_DEMO, FORALL_NEGATE, RANK8_SLICES
...
run_active_test (void)
{
  ...
  run_rank8_slices ();
#endif
#if !defined(TEST_FORALL_DV_CROSS) \
