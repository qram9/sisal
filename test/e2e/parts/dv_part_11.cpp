...
// Groups: SIMPLEBATCHER_DV, SEQBATCHER_DV, BATCHER_DV, ANGMOM_DV, VSPHERE_DV, ENERGY_DV, SPECAM_DV, SAS_DV, LINEAR_DV, UVSPEC_DV, SPEC_DV, NOISE_DV, TST_LOOPX_DV, TST_LOOPX2_DV
...
run_active_test (void)
{
  ...
  test_tst_loopx2_dv ();
#endif
#if !defined(TEST_SIMPLEBATCHER_DV) \
