...
// Groups: FORINIT_GATHER_GROWTH_DV, PSA_RNG_DV, XFA_DEP_EXPR, PSA_SWAP_DV, PSA_UPDATE_DV, PSA_DV, FORINIT_CATENATE_DV, SSPHOT_GEOM_DV, SSPHOT_CELLS_DV, SSPHOT_INTERP_DV, XFA_SCATTER_EXPR_DV, SSPHOT_OPAC_DV, SSPHOT_MOVE_DV
...
run_active_test (void)
{
  ...
  test_ssphot_move_dv ();
#endif
#if !defined(TEST_FORINIT_GATHER_GROWTH_DV) \
