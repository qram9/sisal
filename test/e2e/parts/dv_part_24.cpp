...
// Groups: SSPHOT_MOVE_DV, PSA_COST_DV, MOLDYN_NEIGHBORS_DV, MOLDYN_NBRLIST_DV, ZEROTRIP_EXPR_DV, GAUSSDATA_DV, ARSIEVE_DV, INITAL_DV, PASSGRID_DV, IFG_4_DV, IFG_3_DV, IFG_2ETC_DV, PASSFREQ_DV, MDFFTFREQ_DV
...
run_active_test (void)
{
  ...
  test_mdfftfreq_dv ();
#endif
#if !defined(TEST_SSPHOT_MOVE_DV) \
