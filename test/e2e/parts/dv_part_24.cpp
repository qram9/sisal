...
// Groups: MOLDYN_NBRLIST_DV, ZEROTRIP_EXPR_DV, GAUSSDATA_DV, ARSIEVE_DV, INITAL_DV, PASSGRID_DV, IFG_4_DV, IFG_3_DV, IFG_2ETC_DV, PASSFREQ_DV, MDFFTFREQ_DV, MDFFTGRID_DV, NEWSIEVE_DV
...
run_active_test (void)
{
  ...
  test_newsieve_dv ();
#endif
#if !defined(TEST_MOLDYN_NBRLIST_DV) \
