...
// Groups: FORINIT_REDUCE_DV, WORDCOUNT_DV, BACKTRACK_DV, SUCCESSOR_DV, GENLINKS_DV, GENARCS_DV, TRACEUTIL_DV, ARCGRID_DV, TRACE_DV, JOB_DV, MOLDYN_FORCE_DV, MOLDYN_DIFFUN_DV, MOLDYN_RK_DV, MOLDYN_RKF45_DV, MOLDYN_SOLVE_DV, MOLDYN_DV, GATHER_CONFORM_DV, ADDH_ROW_DV, FORINIT_GATHER_GROWTH_DV, PSA_RNG_DV, XFA_DEP_EXPR
...
run_active_test (void)
{
  ...
  test_xfa_dep_expr ();
#endif
#if !defined(TEST_FORINIT_REDUCE_DV) \
    ...
    && !defined(TEST_GATHER_CONFORM_DV) \
