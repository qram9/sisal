...
// Groups: SHAPED_GATHER_DV, FORINIT_MAT_GATHER_DV, SCATTER_AT_DV, GROW_NEST_DV, TRANSPOSE_AT_DV, FORALL_ROWSCATTER_DV, SMOOTH_DV, DFT_DV, RECORD_OPS_DV, ARRAY_ADD_DV, PICK_DV, ZERO_ARRAYS, CPXFUNCS_DV, XFA_B4_REDUCE
...
run_active_test (void)
{
  ...
  test_xfa_b4_reduce ();
#endif
#if !defined(TEST_SHAPED_GATHER_DV) \
