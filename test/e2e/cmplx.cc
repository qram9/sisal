  ...
  case union_98_D: {
    {
      ...
      sisal_array_t v_D_11017_n__0_UNION_INPUT = {0};
      sisal_array_t v_D_11017_n__0_p0_i = v_g1_n__0_UNION_INPUT.val.D;
      (v_D_11017_n__0_p0_i = SISAL_CAST(sisal_array_t, v_D_11017_n__0_p0_i));
      float v_D_11017_n__1_p0_o = 0;
      {
        ...
        struct union_un_98 v_FORALL_11018_n__0_UNION_INPUT = v_g1_n__0_UNION_INPUT;
        ...
        for (int32_t __k_11020 = 0; (__k_11020 < ((int32_t)v_GENERATOR_11020_n__0_PAYLOAD.size)); (__k_11020++)) {
          ...
          (v_BODY_11021_n__0_PAYLOAD = SISAL_CAST(sisal_array_t, v_FORALL_11018_n__0_PAYLOAD));
          (v_BODY_11021_n__0_UNION_INPUT = v_FORALL_11018_n__0_UNION_INPUT);
  ...
  case union_98_A: {
    {
      ...
      int32_t v_A_11010_n__0_UNION_INPUT = 0;
      int32_t v_A_11010_n__0_p0_i = v_g1_n__0_UNION_INPUT.val.A;
      (v_A_11010_n__0_p0_i = SISAL_CAST(int32_t,v_A_11010_n__0_p0_i ));
      float v_A_11010_n__1_p0_o = 0;
      {
        ...
        (v_INIT_11015_n__0_PAYLOAD = SISAL_CAST(int32_t, v_LoopB_11011_n__0_PAYLOAD));
        (v_INIT_11015_n__0_UNION_INPUT = v_LoopB_11011_n__0_UNION_INPUT);
        ...
        (v_TEST_11014_n__0_PAYLOAD = SISAL_CAST(int32_t, v_LoopB_11011_n__0_PAYLOAD));
        (v_TEST_11014_n__0_UNION_INPUT = v_LoopB_11011_n__0_UNION_INPUT);
        ...
        while (v_TEST_11014_n__4_p0_o) {
          ...
          (v_BODY_11012_n__0_PAYLOAD = SISAL_CAST(int32_t, v_LoopB_11011_n__0_PAYLOAD));
          (v_BODY_11012_n__0_UNION_INPUT = v_LoopB_11011_n__0_UNION_INPUT);
...
extern "C" float func_MAIN(int32_t INPUT_SEL, float INPUT_VAL, int32_t INPUT_SIZE) {
  ...
  float v_g2_n__1_p0_o = 0;
  {
    ...
    (v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SEL = SISAL_CAST(int32_t, v_LET_NON_REC_10001_n__0_INPUT_SEL));
    int32_t v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SIZE = 0;
    (v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SIZE = SISAL_CAST(int32_t, v_LET_NON_REC_10001_n__0_INPUT_SIZE));
    float v_IF_union_MISSING_ID_0____10002_n__0_INPUT_VAL = 0;
    (v_IF_union_MISSING_ID_0____10002_n__0_INPUT_VAL = SISAL_CAST(float, v_LET_NON_REC_10001_n__0_INPUT_VAL));
    {
      int32_t v_PREDICATE_10003_n__0_INPUT_SEL = 0;
      (v_PREDICATE_10003_n__0_INPUT_SEL = SISAL_CAST(int32_t, v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SEL));
      ...
      if (v_PREDICATE_10003_n__2_p0_o) {
        ...
        (v_THEN_10008_n__0_INPUT_SIZE = SISAL_CAST(int32_t, v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SIZE));
        ...
        (v_ELSE_10004_n__0_INPUT_SEL = SISAL_CAST(int32_t, v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SEL));
        int32_t v_ELSE_10004_n__0_INPUT_SIZE = 0;
        (v_ELSE_10004_n__0_INPUT_SIZE = SISAL_CAST(int32_t, v_IF_union_MISSING_ID_0____10002_n__0_INPUT_SIZE));
        float v_ELSE_10004_n__0_INPUT_VAL = 0;
        (v_ELSE_10004_n__0_INPUT_VAL = SISAL_CAST(float, v_IF_union_MISSING_ID_0____10002_n__0_INPUT_VAL));
        {
          int32_t v_PREDICATE_10005_n__0_INPUT_SEL = 0;
          (v_PREDICATE_10005_n__0_INPUT_SEL = SISAL_CAST(int32_t, v_ELSE_10004_n__0_INPUT_SEL));
          ...
          if (v_PREDICATE_10005_n__2_p0_o) {
            ...
            (v_THEN_10007_n__0_INPUT_VAL = SISAL_CAST(float, v_ELSE_10004_n__0_INPUT_VAL));
            ...
            (v_ELSE_10006_n__0_INPUT_SIZE = SISAL_CAST(int32_t, v_ELSE_10004_n__0_INPUT_SIZE));
            (v_ELSE_10006_n__0_INPUT_VAL = SISAL_CAST(float, v_ELSE_10004_n__0_INPUT_VAL));
