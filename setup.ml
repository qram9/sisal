...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2dda481581dc117b887f97b58ee4b67d) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [FindlibPackage ("unix", None); InternalLibrary "ir"];
                      bs_build_tools =
                        [
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/qram9/sisal.git";
                      src_repo_browser =
                        Some "https://github.com/qram9/sisal";
     ...
     oasis_digest = Some "\143\162\018\127j\129Q\254S3\141\137\211z\223\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
