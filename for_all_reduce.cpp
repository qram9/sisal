...
extern "C" int32_t func_MAIN(int32_t X) {
  ...
  int32_t v_g1_n__1_p0_o = 0;
  {
    ...
    bool v_FORALL_10001_n__3___forall_mask_0;
    ...
    for ((v_GENERATOR_10003_n__3_I = 1); (v_GENERATOR_10003_n__3_I <= 10); (v_GENERATOR_10003_n__3_I++)) {
      ...
      (v_BODY_10004_n__1_p0_o = SISAL_CAST(int32_t, 100));
      int32_t v_BODY_10004_n__2_p0_o = 0;
      (v_BODY_10004_n__2_p0_o = SISAL_CAST(int32_t, 100));
      int32_t v_BODY_10004_n__3_p0_o = 0;
      (v_BODY_10004_n__3_p0_o = SISAL_CAST(int32_t, 5));
      int32_t v_BODY_10004_n__4_p0_o = 0;
      (v_BODY_10004_n__4_p0_o = SISAL_CAST(int32_t, (SISAL_CAST(int32_t, v_BODY_10004_n__0_I) - SISAL_CAST(int32_t, v_BODY_10004_n__3_p0_o))));
      (v_BODY_10004_n__6_VAL = SISAL_CAST(int32_t, (SISAL_CAST(int32_t, v_BODY_10004_n__2_p0_o) / SISAL_CAST(int32_t, v_BODY_10004_n__4_p0_o))));
      int32_t v_BODY_10004_n__7_p0_o = 0;
      (v_BODY_10004_n__7_p0_o = SISAL_CAST(int32_t, 5));
      bool v_BODY_10004_n__8_p0_o = 0;
      (v_BODY_10004_n__8_p0_o = SISAL_CAST(bool, (SISAL_CAST(int32_t, v_BODY_10004_n__0_I) > SISAL_CAST(int32_t, v_BODY_10004_n__7_p0_o))));
      if (v_BODY_10004_n__8_p0_o) {
        (v_g1_n__1_p0_o = (v_g1_n__1_p0_o + SISAL_CAST(int32_t, v_BODY_10004_n__6_VAL)));
      }
      (__g_10001++);
    }
  }
